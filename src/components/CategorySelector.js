...
const CategorySelector = ({ categoryId, category }) => {
    ...
    return (
        <div className="bg-white rounded-lg h-40 cursor-pointer relative border-2 border-gray-300" onClick={handleCategorySelected}>
            <div className="absolute top-0 right-0 py-6 px-6">
                <img src={getCategoryIcon(categoryId)} className="w-10" />
            </div>
